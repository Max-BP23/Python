...
- *,**
  ...
  func(22,33,99) # (22,33,99) {} 这个只是位置参数,第二个不计算
  func(n1="武沛齐",age=18) # 关键字 (){n1:"武沛齐",age:18}
  func(22,33,99,n1="武沛齐",age=18) #前三个位置参数,后面是关键字 (22,33,99){n1:"武沛齐",age:18}
  func(n1="武沛齐",22,33,99,age=18) #第一个是关键字,后面都是关键字 运行错误
  func() # (){}
  ```
...
- 函数一旦遇到return就会立即退出函数（终止函数中的所有代码）
  ...
  # 输出
  1 print(1)
  0 # 输完0,return之后循环不再执行,下面的print(2)也不再执行
  999 # print(result)
  ```
